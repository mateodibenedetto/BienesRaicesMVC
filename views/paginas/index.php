...
<section data-cy="imagen-contacto" class="imagen-contacto">
    ...
    <a href="/public/contacto" class="boton-amarillo">Contactános</a>
</section>
    <!-- // Contacto -->
...
<div class="contenedor seccion seccion-inferior">
    ...
    <section data-cy="testimoniales" class="testimoniales">
        ...
        <div class="testimonial">
            <blockquote>
                El personal se comportó de una excelente forma, muy buena atención y las casas que me ofrecieron
